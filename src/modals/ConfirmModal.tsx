                ...
                <Dialog as="div" className="relative z-[999]" onClose={() => dispatch?.close(false)}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className=" flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="bg-bgModal shadow-popover relative w-[355px] rounded-xl transition-all dark:text-gray-950">
                                    ...
                                    <div className="flex flex-col gap-[12px] p-[24px]">
                                        {content}
                                        <button
                                            className=" bg-commonDanger text-lightBottom flex items-center justify-center rounded-full py-[11px] font-bold"
                                            onClick={async () => {
                                                dispatch?.close(true);
                                            }}
                                        >
