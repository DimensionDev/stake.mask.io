...
export function StakeCard() {
  ...
  console.log(data)
  return <div className="flex flex-col border-[1px] border-neutrals6 h-[196px] rounded-[16px] p-[16px]">
    <Image src="/glow.png" width={280} height={200} alt='right' className='absolute top-[-30px] left-[-35px] z-1' />
